...
from fluentogram import FluentTranslator, TranslatorHub, TranslatorRunner, MoneyTransformer, DateTimeTransformer
...
shop-success-payment = Your money, { $amount }, has been sent successfully at { $dt }.
        ...
        print(
            ...
            translator_runner.shop.success.payment(amount=MoneyTransformer(currency="$", amount=Decimal("500")),
