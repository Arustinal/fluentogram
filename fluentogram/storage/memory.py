...
from fluentogram.storage.base import AbstractStorage
from fluentogram.translator import FluentTranslator


class MemoryStorage(AbstractStorage):
    """Default storage implementation using dictionary."""

    def __init__(self, translators: dict[str, FluentTranslator] | None = None) -> None:
        self._storage: dict[str, FluentTranslator] = translators or {}
